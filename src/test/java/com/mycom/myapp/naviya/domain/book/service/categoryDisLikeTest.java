...
class categoryDisLikeTest {
    ...
    void testCategoryLike_Success() {
        ...
        // When
        BookResultDto result = yourService.CategoryDisLike(childId, categoryCode);
        ...
        assertEquals(47L, updatedCategory.getChildFavorCategoryWeight(), "Weight should be updated to 60");
    }
    @Test
